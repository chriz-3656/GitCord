...
export class LeaderboardService {
     ...
     */
    static calculateContributorScore(stats) {
        return (stats.commits * 1 + // 1 point per commit
     ...
     */
    static async getTrendingRepositories(limit = 10, daysBack = 7) {
     ...
     */
    static async getMostActiveProjects(limit = 10) {
    ...
    static async getRepoOfTheWeek() {
        ...
        for (const repo of repos) {
            ...
            const score = repo.interactions.length * 2 +
     ...
     */
    static async getMostHelpfulContributors(limit = 10) {
     ...
     */
    static async getHallOfFame(limit = 10) {
     ...
     */
    static async getCategoryRanking(category, limit = 10) {
