...
export const NotificationSettingsCommand = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub.setName('view').setDescription('View your current notification settings'),
    )
    .addSubcommand((sub) =>
      sub
        .setName('silent-mode')
        ...
        .addBooleanOption((opt) =>
          opt.setName('enabled').setDescription('Enable or disable silent mode').setRequired(true),
        ),
    )
    .addSubcommand((sub) =>
      sub
          ...
          ...CardFactory.createReply([
            new ContainerBuilder()
              ...
              .addTextDisplayComponents(
                new TextDisplayBuilder().setContent('📢 **Your Notification Settings**'),
        ...
        await interaction.reply({
          ...CardFactory.createReply([
            new ContainerBuilder()
              ...
              .addTextDisplayComponents(
                new TextDisplayBuilder().setContent('🔇 **Silent Mode Updated**'),
                new TextDisplayBuilder().setContent(
                  enabled
        ...
        await interaction.reply({
          ...CardFactory.createReply([
            new ContainerBuilder()
              .setAccentColor(enabled ? 0x43b581 : 0xf04747)
              .addTextDisplayComponents(
                new TextDisplayBuilder().setContent('🎉 **Release Notifications Updated**'),
                new TextDisplayBuilder().setContent(
                  enabled
        ...
        await interaction.reply({
          ...CardFactory.createReply([
            new ContainerBuilder()
              .setAccentColor(enabled ? 0x43b581 : 0xf04747)
              .addTextDisplayComponents(
                new TextDisplayBuilder().setContent('👤 **Mention Notifications Updated**'),
                new TextDisplayBuilder().setContent(
                  enabled
