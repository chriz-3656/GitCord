...
export class AchievementService {
   ...
   */
  static async awardBadge(contributorId: string, badgeId: string): Promise<boolean> {
   ...
   */
  static async checkAndAwardBadges(contributor: any): Promise<string[]> {
   ...
   */
  static async getContributorBadges(contributorId: string) {
   ...
   */
  static async hasBadge(contributorId: string, badgeId: string): Promise<boolean> {
    const badge = BADGE_DEFINITIONS[badgeId];
    if (!badge) return false;
   ...
   */
  static async calculateActivityStreak(contributorId: string): Promise<{
    current: number;
    max: number;
  }> {
   ...
   */
  static async getContributionHistory(contributorId: string) {
   ...
   */
  static async getTopLanguages(contributorId: string): Promise<string[]> {
